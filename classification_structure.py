# -*- coding: utf-8 -*-
"""
Created on Mon May  3 21:49:26 2021
...
lrs = tf.keras.optimizers.schedules.ExponentialDecay(
    0.001, 488*66, 0.2, staircase=False, name=None
)


opt = keras.optimizers.Adam(learning_rate=lrs)
#model.compile(optimizer=opt, loss='binary_crossentropy',metrics=["accuracy"])
model.load_weights("checkpoints/classification/2model_76.hdf5")
...
EPOCHS = 1
checkpoint_filepath = "checkpoints/3model_{epoch:02d}.hdf5"
...
model.fit(d_train,validation_data = (X_val,Y_val),callbacks=[model_checkpoint_callback,WandbCallback(save_model=False)],validation_batch_size=2,batch_size=2,epochs=150)
